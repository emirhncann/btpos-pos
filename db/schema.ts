...
export const posSettingsCache = sqliteTable('pos_settings_cache', {
  ...
  allowExitWithHeldDocs: integer('allow_exit_with_held_docs', { mode: 'boolean' }).default(true),
  cariPaymentUsePavo:   integer('cari_payment_use_pavo', { mode: 'boolean' }).default(false),
