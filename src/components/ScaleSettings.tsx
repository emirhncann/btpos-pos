...
export default function ScaleSettings() {
  ...
  useEffect(() => {
    ...
    void window.electron.scale.listPorts().then(setPorts)
  }, [])
    ...
    <div style={{ padding: 16, border: '1px solid #E5E7EB', borderRadius: 12 }}>
      ...
      {testValue && (
        <div style={{
          ...
          background: testValue.startsWith('✓') ? '#E8F5E9' : '#FEF2F2',
          color: testValue.startsWith('✓') ? '#2E7D32' : '#DC2626',
